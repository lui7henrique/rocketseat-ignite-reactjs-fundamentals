...
module.exports = {
  ...
  entry: path.resolve(__dirname, "src", "index.tsx"), // qual é o arquivo inicial da aplicação
  output: {
    path: path.resolve(__dirname, "dist"), // qual é o arquivo que vou gerar com webpack
    filename: "bundle.js",
  },
  resolve: {
    extensions: [".js", ".jsx", ".tsx", ".ts"], // leitor de extensoes de arquivos
  },
  devServer: {
  ...
  module: {
    rules: [
      {
        test: /\.(j|t)sx$/, // regra pra ler arquivos js/jsx
